    ...
    <div className='tokenAllocation'>
       <nav className='nav'>
        ...
        <div className='tokenAllocation-inner'>
            ...
            <p>Carlossy Caterpillar coins will be used as a lot of other coins in the blockchain network to purchase, stake, and trade, allowing them to become another integral part of the system. 
            <p style={{paddingTop:'30px'}}>The total supply of the Carlossy Caterpillar token is 1 billion as it is distributed as follows:</p> </p>
            </div>
            <div className='tokenAllocation-inner1_1'>
                ...
                <div className='sales_percent_inner'>
                    ...
                    <span style={{backgroundColor:'#6A8D00',height:'80px',width:'10px'}}></span>
                    <div>
                    <p style={{color:'#582900',fontWeight:'600'}}>25% Private Sale</p>
                    <p className='grobold'>250,000,000</p>
                    </div>
                    </div>
                    <div className='sales_percent1'>
                    <span style={{backgroundColor:'#A2BE02',height:'80px',width:'10px'}}></span>
                    <div>
                    <p style={{color:'#582900',fontWeight:'600'}}>25% Public Sale</p>
                   <p className='grobold'>150,000,000</p>
                    </div>
                    </div>
                    <div className='sales_percent1'>
                    <span style={{backgroundColor:'#BDDD05',height:'80px',width:'10px'}}></span>
                    <div>
                    <p style={{color:'#582900',fontWeight:'600'}}>10% Founder's Sale</p>
                   <p className='grobold'> 100,000,000</p>
                    </div>
                    </div>
                    <div className='sales_percent1'>
                    <span style={{backgroundColor:'#D9FF00',height:'80px',width:'10px'}}></span>
                    <div>
                    <p style={{color:'#582900',fontWeight:'600'}}>10% Private Sale</p>
                   <p className='grobold'>100,000,000</p>
                    </div>
                    </div>
                </div>
                <div className='sales_percent_inner_2'>
                    ...
                    <span style={{backgroundColor:'#A4FC00',height:'80px',width:'10px'}}></span>
                        <div>
                        <p style={{color:'#582900',fontWeight:'600'}}>10% Presale</p>
                        <p  className='grobold'>100,000,000</p>
                        </div>
                    </div>
                    <div className='sales_percent2'>
                    <span style={{backgroundColor:'#85CD00',height:'80px',width:'10px'}}></span>
                        <div>
                        <p style={{color:'#582900',fontWeight:'600'}}>10% Marketing</p>
                        <p  className='grobold'>100,000,000</p>
                        </div>
                    </div>
                    <div className='sales_percent2'>
                    <span style={{backgroundColor:'#639900',height:'80px',width:'10px'}}></span>
                        <div>
                        <p style={{color:'#582900',fontWeight:'600'}}>10% investments</p>
                        <p  className='grobold'>100,000,000</p>
                        </div>
                        
                    </div>
                    <div className='sales_percent2'>
                    <span style={{backgroundColor:'#476A06',height:'80px',width:'10px'}}></span>
                        <div>
                        <p style={{color:'#582900',fontWeight:'600'}}>10% Strategic Partners</p>
                        <p  className='grobold'>100,000,000</p>
                        </div>
                    </div>
                </div>
        ...
        <div className='table_token'>
            <h2 className='grobold' style={{color:'#582900',textAlign:'center',paddingTop:'50px',paddingBottom:'20px'}}>Token Details</h2>
            ...
            <h2 className='grobold' style={{color:"#582900",textAlign:'center',paddingTop:'50px',paddingBottom:'40px'}}>Presale Stages</h2>
            <div>
                 <div className='row3'>
        ...
        <div className='participate'>
            ...
            <div className='participate_each'>
                ...
                <p className='participate_text'>Create your account on carlossy catarpillar website and verify your account to get started</p>
                </div>
                <div className='participate1'>
                <img src="/images/GroupToken2.png" alt="make payment" />
                <p className='grobold'>2. Make Payment</p>
                <p className='participate_text'>Purchase $CAR token using your preferred means of payment via crypto or fiat transactions</p>
                </div>
                <div className='participate1'>
                <img src="/images/VectorToken.png" alt="recieve Token" />
                <p className='grobold'>3. Recieve token</p>
                <p className='participate_text'>After presale is complete, your purchased token will be airdropped into your connected wallet address.</p>
                </div>
            </div>
        </div>
